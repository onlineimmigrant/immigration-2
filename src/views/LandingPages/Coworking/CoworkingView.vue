...
<template>
  ...
  <Header
    ...
    title="Your Perfect Place for Work" :description="{
      text: 'Anorexia is not good.The time is now for it be okay to be great. People in this world shun people for being nice.',
      class: 'pe-md-5 me-md-5 opacity-8',
    }" mask="mask bg-gradient-dark opacity-5">
    <div class="buttons">
      <MaterialButton variant="gradient" color="success" class="mt-4">Get Started</MaterialButton>
      <MaterialButton color="none" class="mt-4 text-white shadow-none">Read more</MaterialButton>
    </div>
  </Header>
  <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6 mb-4">
    ...
    <Places />
    <div class="container">
      <div class="my-10 py-5 bg-gradient-dark position-relative border-radius-xl" :style="{
        backgroundImage:
            ...
            <div class="col-lg-6 m-auto">
              <div class="row">
                <div class="col-sm-4 col-6 ps-sm-0 ms-auto">
                  <MaterialButton class="mb-0 ms-lg-3 ms-sm-2 mb-sm-0 mb-2 me-auto d-block" variant="gradient"
                    color="warning" fullWidth>Start Now</MaterialButton>
                </div>
              </div>
            </div>
          </div>

                ...
                <div class="col-12 px-4 py-2">
                  <div class="row">
                    <div class="col-4 position-relative">
                      ...
                      <RouterLink :to="{ name: 'coworking' }" class="dropdown-item border-radius-md">
                        <span>Coworking</span>
                      </RouterLink>
                      <RouterLink :to="{ name: 'rental' }" class="dropdown-item border-radius-md">
                        <span>Rental</span>
                      </RouterLink>
                      ...
                      <RouterLink :to="{ name: 'pricing' }" class="dropdown-item border-radius-md">
                        <span>Pricing</span>
                      </RouterLink>
                    ...
                    <div class="col-4 position-relative">
                      ...
                      <RouterLink :to="{ name: 'helpcenter' }" class="dropdown-item border-radius-md">
                        <span>Help Center</span>
                      </RouterLink>
                      <RouterLink :to="{ name: 'contactus' }" class="dropdown-item border-radius-md">
                        <span>Contact Us</span>
                      </RouterLink>
                      <RouterLink :to="{ name: 'faq' }" class="dropdown-item border-radius-md">
                        <span>FAQ</span>
                      </RouterLink>
                      <RouterLink :to="{ name: 'privacy' }" class="dropdown-item border-radius-md">
                        <span>Privacy</span>
                      </RouterLink>
                      <div class="dropdown-header text-dark font-weight-bolder d-flex align-items-center mt-3 px-1">
                        Apps
                      </div>
                      <RouterLink :to="{ name: 'desktop-app' }" class="dropdown-item border-radius-md">
                    ...
                    <div class="col-4">
                      ...
                      <RouterLink :to="{ name: 'single-article' }" class="dropdown-item border-radius-md">
                      ...
                      <RouterLink :to="{ name: 'virtual-reality' }" class="dropdown-item border-radius-md">
            ...
            <div
                ...
                <ul class="list-group">
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    ...
                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                      ...
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-pricing' }">
                        Pricing
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-faq' }">
                        FAQ
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-blog-posts' }">
                        Blog Posts
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-testimonials' }">
                        Testimonials
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-teams' }">
                        Teams
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-stats' }">
                        Stats
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-cta' }">
                        Call to Actions
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-applications' }">
                        Applications
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-logo-areas' }">
                        Logo Areas
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-footers' }">
                        Footers
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-general-cards' }">
                        General Cards
                      </RouterLink>
                  ...
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    ...
                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                      ...
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'inputareas-contact' }">
                        Contact Sections
                      </RouterLink>
                  ...
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    ...
                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                      ...
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'ac-notifications' }">
                        Notifications
                      </RouterLink>
                  ...
                  <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                    ...
                    <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                      ...
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'el-social-buttons' }">
                        Social Buttons
                      </RouterLink>
                      <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'el-tables' }">
                        Tables
                      </RouterLink>
              ...
              <div class="row d-lg-none">
                <div class="col-md-12">
                  ...
                  <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'page-content-sections' }">
                    Content Sections
                  </RouterLink>
                  ...
                  <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'inputareas-newsletter' }">
                    Newsletter
                  </RouterLink>
                  <RouterLink class="dropdown-item ps-3 border-radius-md mb-1" :to="{ name: 'inputareas-contact' }">
                    Contact Sections
